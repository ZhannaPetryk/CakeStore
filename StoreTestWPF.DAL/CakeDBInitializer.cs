    ...
    public class CakeDBInitializer : DropCreateDatabaseAlways<CakeStoreDbContext>
    {
        protected override void Seed(CakeStoreDbContext context)
        {
            ...
            defaultCakes.Add(new Cake
            {
                ...
                { 
                    new Image { Path = "/Resource/Images/Apple_pie.jpg" },
                    new Image { Path = "/Resource/Images/Apple_pie_2.jpg" }
                }
            });
            ...
            defaultCakes.Add(new Cake
            {
                ...
                Images = new List<Image>()
                {
                    new Image { Path = "/Resource/Images/Fraisier.jpg"},
                    new Image { Path = "/Resource/Images/Fraisier_3.jpg"},
                    new Image { Path = "/Resource/Images/Fraisier_4.jpg"}
                }
            });
            ...
            defaultCakes.Add(new Cake
            {
                ...
                Images = new List<Image> 
                { 
                    new Image { Path = "/Resource/Images/Ciasto_czekoladowo_migdałowe_z_gruszkami.jpg" } 
                }
            });
            ...
            defaultCakes.Add(new Cake
            {
                ...
                Images = new List<Image>
                {
                    new Image { Path = "/Resource/Images/Kokosowy_sernik_królewski.jpg" }
                }
            });
            ...
            defaultCakes.Add(new Cake
            {
                ...
                Images = new List<Image>
                {
                    new Image { Path = "/Resource/Images/Tarta_z_mascarpone_rabarbarem_i_truskawkami.jpg" }
                }
            });
